...
- **MCP-compatible.** Skills can be exposed via MCP servers (ADR-007), making them callable not just by the lab's orchestrator but by any MCP client a chemist uses on their personal workstation.
